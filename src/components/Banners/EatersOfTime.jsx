      ...
      <div className="banner-content">
        <div className="banner-row">
          ...
          <div className="text-content">
            ...
            <p>
              A land now divided by war, where ancient sorcery and monstrous threats lurk ever closer. 
              Sir Kaith and three other heroes rise to protect the world, but can they truly outwit the 
              darkness and save Skolf?
            </p>
           <Link to="/Eaters" className="buy-button">
              Find Out More
            </Link>
          </div>
        </div>
